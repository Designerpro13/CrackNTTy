...
- [ ] 1. Create the Operation Store
  - [ ] 1.1 Create `src/stores/operationStore.ts` with Zustand
  ...
  - [ ] 1.2 Implement `executeOperation()` in the operation store
...
- [ ] 3. Build the ToolSidebar component
  - [ ] 3.1 Create `src/components/ToolSidebar.tsx`
...
- [ ] 4. Build the ToolNode component
  - [ ] 4.1 Create `src/components/ToolNode.tsx`
  ...
  - [ ] 4.2 Implement context menu actions in ToolNode
...
- [ ] 5. Build the OperationControls component
  - [ ] 5.1 Create `src/components/OperationControls.tsx`
...
- [ ] 7. Wire up the Operation View
  - [ ] 7.1 Rewrite `src/views/Operation.tsx` with full layout
  ...
  - [ ] 7.2 Implement drag-and-drop handlers in Operation.tsx
  ...
  - [ ] 7.3 Implement edge animation based on operation status
  ...
  - [ ] 7.4 Connect Execute button to store's executeOperation
